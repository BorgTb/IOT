...
// --- Endpoint 1: Stream de Video a 30 FPS ---
esp_err_t stream_handler(httpd_req_t *req) {
    ...
    // Encabezado para evitar bloqueos de CORS en tu Dashboard
...
void loop() {
    // El ESP32 ya no publica por MQTT, solo sirve los endpoints HTTP.
    delay(10000);
}